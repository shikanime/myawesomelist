...
func (c *Client) GetCollection(
	...
	} else if err = c.d.UpsertProjectMetadata(ctx, []*database.ProjectMetadata{&database.ProjectMetadata{RepositoryID: rms[0].ID, Readme: string(content)}}); err != nil {
...
func (c *Client) GetProjectStats(
	...
	} else if err := c.d.UpsertProjectStats(ctx, []*database.ProjectStats{&database.ProjectStats{RepositoryID: rms[0].ID, StargazersCount: stats.StargazersCount, OpenIssueCount: stats.OpenIssueCount}}); err != nil {
